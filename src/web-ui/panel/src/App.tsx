...
import type { Bootstrap, ConfigItem, Dashboard, DayUsage, EntryRow, Filters, RootsView } from './api'
...
function CollectionsPage({ bootstrap }: { readonly bootstrap: Bootstrap }): JSX.Element {
